...
import { useCurrentUser } from '@/hooks/auth/use-current-user'; // Ensure consistent path
    ...
    const footerLinks = [
        {
            ...
            items: [
                { name: 'Feed', href: '/feed' },
                {
                    name: user ? 'My Profile' : 'Create Profile',
                    href: user ? `/profile/${user._id}` : '/auth/signup'
                },
            ]
        },
        {
